...
(cl:defmethod cl:initialize-instance :after ((m <Pose2DStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose2DStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nav_2d_msgs-msg:<Pose2DStamped> is deprecated: use nav_2d_msgs-msg:Pose2DStamped instead.")))
...
(cl:defmethod pose-val ((m <Pose2DStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nav_2d_msgs-msg:pose-val is deprecated.  Use nav_2d_msgs-msg:pose instead.")
  (pose m))
