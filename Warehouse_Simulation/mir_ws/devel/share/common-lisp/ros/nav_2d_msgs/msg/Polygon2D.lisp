...
(cl:defclass <Polygon2D> (roslisp-msg-protocol:ros-message)
  ((points
    :reader points
    :initarg :points
    :type (cl:vector nav_2d_msgs-msg:Point2D)
   :initform (cl:make-array 0 :element-type 'nav_2d_msgs-msg:Point2D :initial-element (cl:make-instance 'nav_2d_msgs-msg:Point2D))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Polygon2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Polygon2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nav_2d_msgs-msg:<Polygon2D> is deprecated: use nav_2d_msgs-msg:Polygon2D instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <Polygon2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nav_2d_msgs-msg:points-val is deprecated.  Use nav_2d_msgs-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Polygon2D>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'nav_2d_msgs-msg:Point2D))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Polygon2D>)))
  ...
  (cl:format cl:nil "Point2D[] points~%~%================================================================================~%MSG: nav_2d_msgs/Point2D~%float64 x~%float64 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Polygon2D)))
  "Returns full string definition for message of type 'Polygon2D"
  (cl:format cl:nil "Point2D[] points~%~%================================================================================~%MSG: nav_2d_msgs/Point2D~%float64 x~%float64 y~%~%~%"))
