...
class NavigateToPoseActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = NavigateToPoseGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NavigateToPoseActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = NavigateToPoseGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += NavigateToPoseGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavigateToPoseActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = NavigateToPoseGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new NavigateToPoseGoal()
    }
...
module.exports = NavigateToPoseActionGoal;
