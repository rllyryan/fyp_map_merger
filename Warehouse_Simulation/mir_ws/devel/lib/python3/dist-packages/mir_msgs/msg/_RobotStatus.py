...
class RobotStatus(genpy.Message):
  _md5sum = "38b4cd736e11dcb63d6a67a60bbb51c3"
...
duration timeout
"""
  __slots__ = ['battery_percentage','battery_time_remaining','battery_voltage','distance_to_next_target','errors','footprint','hook_status','map_id','unloaded_map_changes','mission_queue_id','mission_text','mode_id','mode_text','moved','position','robot_name','session_id','software_version','state_id','state_text','uptime','velocity','user_prompt','safety_system_muted','joystick_low_speed_mode_enabled','joystick_web_session_id','mode_key_state']
  _slot_types = ['float32','int32','float32','float32','mir_msgs/Error[]','string','mir_msgs/HookStatus','string','bool','int32','string','int32','string','float64','mir_msgs/Pose2D','string','string','string','uint8','string','int32','mir_msgs/Twist2D','mir_msgs/UserPrompt','bool','bool','string','string']
