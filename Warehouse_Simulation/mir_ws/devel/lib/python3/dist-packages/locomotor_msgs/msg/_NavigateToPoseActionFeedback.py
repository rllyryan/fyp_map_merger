...
"""autogenerated by genpy from locomotor_msgs/NavigateToPoseActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class NavigateToPoseActionFeedback(genpy.Message):
  _md5sum = "a45beabaf7135f1caafb275c8209ea86"
  _type = "locomotor_msgs/NavigateToPoseActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','locomotor_msgs/NavigateToPoseFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NavigateToPoseActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = locomotor_msgs.msg.NavigateToPoseFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = locomotor_msgs.msg.NavigateToPoseFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.state.global_pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.feedback.state.local_pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.feedback.state.goal.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.feedback.state.current_velocity.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.feedback.state.command_velocity.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.feedback.state.global_plan.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
