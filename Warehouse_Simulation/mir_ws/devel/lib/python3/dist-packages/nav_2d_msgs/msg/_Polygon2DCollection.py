...
"""autogenerated by genpy from nav_2d_msgs/Polygon2DCollection.msg. Do not edit."""
import codecs
import sys
...
class Polygon2DCollection(genpy.Message):
  _md5sum = "a0186b831cfbcfeafd72a58884a4efe9"
  _type = "nav_2d_msgs/Polygon2DCollection"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Primarily used for visualization
# Colors are optional
...
"""
  ...
  _slot_types = ['std_msgs/Header','nav_2d_msgs/ComplexPolygon2D[]','std_msgs/ColorRGBA[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Polygon2DCollection, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.polygons:
        ...
        length = len(val1.inner)
        buff.write(_struct_I.pack(length))
        for val2 in val1.inner:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = nav_2d_msgs.msg.ComplexPolygon2D()
        _v2 = val1.outer
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        val1.inner = []
        for i in range(0, length):
          val2 = nav_2d_msgs.msg.Polygon2D()
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          val2.points = []
