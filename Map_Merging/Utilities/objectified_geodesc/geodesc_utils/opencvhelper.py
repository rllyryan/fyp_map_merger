...
class SiftWrapper(object):
    ...
    def __init__(self, nfeatures=0, n_octave_layers=15,
                 peak_thld=0.0067, edge_thld=10, sigma=8.0,
    ...
    def create(self):
        ...
        self.sift = cv2.SIFT_create(
            self.nfeatures, self.n_octave_layers, self.peak_thld, self.edge_thld, self.sigma) # used to be cv2.xfeatures2d.SIFT_create()
